export const translations = {
  ...
  en: {
    ...
    // Profile Views Section - Detailed
    profileViews: {
      sectionTitle: "A Solution for",
      sectionTitleHighlight: "Every Profile",
      sectionSubtitle:
        "Personalized interfaces that meet the specific needs of each type of user, from administrators to end customers.",
      viewDemo: "View Demo",
      ...
      administrator: {
        ...
        feature4: "Advanced reports and analyses",
    ...
    featuresSection: {
      ...
      kanban: {
        ...
        feature3Desc: "Identify urgent orders quickly with colors and labels",
        mockPending: "Pending",
      ...
      equipment: {
        ...
        feature3Desc: "Automatically link equipment to service orders",
        mockTitle: "Equipment",
      },
      orders: {
        tab: "Orders",
        ...
        description:
          "Manage each order with complete information organized in tabs: details, defect, executed service, and attachments.",
        feature1Title: "Complete Information",
        feature1Desc: "Register all order details with customizable fields",
    ...
    customizationSection: {
      ...
      lightThemeDesc: "Clear and modern interface",
      darkTheme: "Dark Theme",
      darkThemeDesc: "Reduces visual fatigue",
      autoTheme: "Automatic",
      autoThemeDesc: "Adapts to the system",
    },
    // Demo Section
    // Demo Section - Detailed
    demoSection: {
      ...
      subtitle:
        "Schedule a customized demonstration and discover how Ordemly can transform your company's service order management.",
      feature1Title: "Customized Demonstration",
      feature1Desc: "Presentation focused on your company's specific needs",
      feature2Title: "30 Minutes",
      feature2Desc: "Enough time to know all the main functionalities",
      feature3Title: "No Commitment",
      feature3Desc: "Know the system without any contract obligation",
      proposalTitle: "Custom Proposal",
      proposalDesc:
        "After the demonstration, we elaborate a tailored proposal for your company's needs, without fixed table values.",
      formTitle: "Schedule Demonstration",
      nameLabel: "Full Name *",
    ...
    contactSection: {
      ...
      hoursMonFriValue: "8 AM to 6 PM",
      hoursSat: "Saturday",
      hoursSatValue: "8 AM to 12 PM",
      hoursSun: "Sunday",
      ...
      messagePlaceholder: "Describe your doubt or need...",
      submitButton: "Send Message",
      successTitle: "Message Sent!",
      successMessage: "We will respond soon. Thank you for contacting us!",
    },
    // Footer
    // Footer - Detailed
    footerSection: {
    ...
    pricingSection: {
      ...
      customPrice: "Consult",
      customPriceNote: "Price based on your needs and complexity",
      ...
      starterFeature4: "Kanban visualization",
      starterFeature5: "Equipment management",
      starterFeature6: "Email support",
      customFeature1: "All features of the Starter Plan",
  ...
  es: {
    ...
    hero: {
      ...
      ctaLearnMore: "Aprender Más",
      trustedBy: "Confiable por empresas en todo Brasil",
    },
    // Benefits Section
    benefits: {
    ...
    profileViews: {
      ...
      sectionTitleHighlight: "Cada Perfil",
      sectionSubtitle:
        "Interfaces personalizadas que atienden las necesidades específicas de cada tipo de usuario, desde administradores hasta clientes finales.",
      ...
      administrator: {
        ...
        feature1: "Tablero con métricas completas y KPIs",
    ...
    featuresSection: {
      ...
      dashboard: {
        ...
        mockPerformance: "Desempeño Mensual",
      },
      kanban: {
        tab: "Kanban",
    ...
    customizationSection: {
      ...
      brandingFeature4: "Email branding",
      previewTitle: "Vista de Temas",
      lightTheme: "Tema Claro",
      lightThemeDesc: "Interfaz clara y moderna",
      darkTheme: "Tema Oscuro",
      darkThemeDesc: "Reduce el cansancio visual",
      autoTheme: "Automático",
      autoThemeDesc: "Adapta al sistema",
    },
    // Demo Section
    // Demo Section - Detailed
    demoSection: {
    ...
    contactSection: {
      ...
      hoursMonFriValue: "8 AM a 6 PM",
      hoursSat: "Sábado",
      hoursSatValue: "8 AM a 12 PM",
      hoursSun: "Domingo",
      hoursSunValue: "Cerrado",
      supportTitle: "Soporte Técnico",
      supportDesc:
        "Los clientes activos tienen acceso prioritario a soporte técnico a través de chat, email y teléfono.",
      supportButton: "Acceder a Centro de Ayuda",
    ...
    // Pricing Section
    pricingSection: {
      badge: "Planos Flexibles",
      title: "Elija el Plan",
      titleHighlight: "Ideal",
      subtitle:
        "Soluciones personalizadas para empresas de todos los tamaños. Entre en contacto para discutir sus necesidades.",
      starterTitle: "Plan Inicial",
      starterSubtitle: "Para pequeñas empresas",
      starterPriceNote: "A partir de",
      perMonth: "/mes",
      customTitle: "Plan Personalizado",
      customSubtitle: "Para empresas en crecimiento",
      customPrice: "Por Consulta",
      ...
      starterFeature3: "Tablero con métricas esenciales",
      starterFeature4: "Visualización Kanban",
      starterFeature5: "Gestión de equipos",
      starterFeature6: "Soporte por email",
      customFeature1: "Todos los recursos del Plan Inicial",
      customFeature2: "Usuarios ilimitados",
      customFeature3: "Personalización completa de la marca",
      customFeature4: "Dominio personalizado",
      customFeature5: "Integraciones personalizadas",
      customFeature6: "Soporte prioritario 24/7",
      customFeature7: "Formación dedicada de la equipo",
      bottomNote:
        "Todos los planes incluyen actualizaciones gratuitas y soporte técnico. Entre en contacto para una propuesta personalizada.",
