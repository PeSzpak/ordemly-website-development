export const translations = {
  pt: {
    ...
    pricingSection: {
      ...
      customFeature3: "Personalização completa da marca",
      customFeature4: "Domínio customizado",
    ...
    quoteModal: {
      ...
      infoNote:
        "Ao clicar em enviar, seu cliente de email será aberto com as informações preenchidas. Você poderá revisar antes de enviar.",
  ...
  en: {
    ...
    quoteModal: {
      ...
      infoNote:
        "When you click submit, your email client will open with the filled information. You can review before sending.",
      cancelButton: "Cancel",
      submitButton: "Send Request",
      greeting: "Hello, I would like to request a quote for Ordemly.",
      planLabel: "Plan of Interest",
  ...
  es: {
    ...
    quoteModal: {
      ...
      infoNote:
        "Al hacer clic en enviar, su cliente de correo se abrirá con la información completada. Podrá revisar antes de enviar.",
      cancelButton: "Cancelar",
      submitButton: "Enviar Solicitud",
      greeting: "Hola, me gustaría solicitar un presupuesto para Ordemly.",
      planLabel: "Plan de Interés",
